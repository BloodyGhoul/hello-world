...
?>
		 ...
		 <br>
		 <h4>Pertandingan Memasak, Gubahan Bunga dan Mewarna Anjuran PPDC & COMBI - 21 Februari 2016</h4>

		 <table border="0">
			 <tr align="center">
				 <td><a href="#"><img src="img/2016/pertandinganMemasakGubahanMewarnaPpdcNCombi/20160221.png" width="800" height=""/></a></td>
			 </tr>
		 </table>

		 <br>
		 <p>
		 Program : Pertandingan Memasak, Gubahan Bunga dan Mewarna telah diadakan pada
		 21 Februari 2016 bertempat di bawah Blok Cempaka. Pemenang bagi pertandingan memasak ialah Syahidah daripada 07-07, Blok Cempaka.
		 Pemenang pertandingan gubahan bunga pula ialah Nisa daripada 06-11, Blok Dahlia. Manakala pemenang bagi pertandingan mewarna jatuh kepada adik Hakim.
		 Tahniah diucapkan kepada pemenang-pemenang. 
		 </p>
		 <br>
		 <h4>Gotong-Royong Tebang Pokok Dengan Majlis Perbandaran Selayang (MPS) - 10 Januari 2016</h4>

		 <table border="0">
			 <tr align="center">
				 <td><a href="#"><img src="img/2016/groyongTebangPokokDgnMps/20160110.png" width="800" height=""/></a></td>
			 </tr>
		 </table>

		 <br>
		 <p>
		 Program : Gotong-Royong Tebang Pokok Dengan MPS telah diadakan pada
		 10 Januari 2016 bertempat di sekitar Blok Dahlia dan Blok Cempaka. 
		 </p>	 
		...
		<br>
		 ...
		 <br>
		 <h4>Hari Berbuka Puasa dan Bubur Lambuk - 7 Ogos 2011</h4>
		 ...
		 <h4>Hari Sukaneka - 26 Jun 2011</h4>
